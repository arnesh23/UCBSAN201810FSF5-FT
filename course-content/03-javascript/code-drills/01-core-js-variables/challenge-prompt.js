...
var statementOne = "Programmers:" + " " + fullName + " " + nationality +" "+ profession +" "+ birthYear;
...
// much like you did for the console logs and `fullName`
var statementTwo = "She is known for " + knownFor;
...
// much like you did for the console logs and `fullName`
var statementThree = "In " + yearOfPublish + " she published" + firstAlgorithm + " the Analytical Engine, at the age of "+ageAtYearOfPublish;
...
// much like you did for the console logs and `fullName`
var statementFour = "She was a " + nationality +" citizen who lived in " + cityLocation +","+countryLocation+" until her passing in "+ageAtPassing;
