...
// Using the names given in the `toyArray`, construct toy objects and create a new arr  ay, `toyObjectArray`, filled with those 5 new `Toy Objects`.
